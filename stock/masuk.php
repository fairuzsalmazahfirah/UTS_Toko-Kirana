...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if($jumlah >= $qtyskrg){
            ...
            $updatedata1 = mysqli_query($conn, "update sbrg_masuk set tgl='$tanggal',jumlah='$jumlah',keterangan='$keterangan',Harga Bayar='$Harga Bayar' where id='$id'");
            ...
            $updatedata = mysqli_query($conn, "update sbrg_masuk set tgl='$tanggal', jumlah='$jumlah', keterangan='$keterangan',Harga Bayar='$Harga Bayar' where id='$id'");
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="active">
                                    <li class="active"><a href="masuk.php"><i class="ti-plus"></i><span>Barang Masuk / Kembali</span></a></li>
											...
											while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="date" id="tanggal" name="tanggal" class="form-control" value="<?php echo date('Y-m-d'); ?>" disabled>
                                                            
                                                            <label for="nama">Barang</label>
                                                            <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $b['nama'] ?> <?php echo 'Merk Barang '.$b['merk'] ?> <?php echo 'Jenis Barang '.$b['jenis'] ?>" disabled>
                                                            ...
                                                            <label for="Harga Bayar">Harga Bayar</label>
                                                            <input type="text" id="Harga Bayar" name="Harga Bayar" class="form-control" value="<?php echo $b['Harga Bayar'] ?>">
						...
						<div class="modal-body">
							<form action="barang_masuk_act.php" method="post">
								<div class="form-group">
									<label>Tanggal</label>
									<input name="tanggal" type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>" disabled>
								</div>
								<div class="form-group">
                                ...
                                <div class="form-group">
									...
									<input name="Harga Bayar" type="number" min="1" class="form-control" placeholder="Harga Bayar" required>
								</div>
