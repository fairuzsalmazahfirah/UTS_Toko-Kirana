...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_brg set nama='$nama', jenis='$jenis', merk='$merk', ukuran=0, satuan='$satuan', lokasi='$lokasi' where idx='$idx'");
...
<body class="wrapper">
			...
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="tmb_brg_act.php" method="post" onsubmit="return validateForm()">
								<div class="form-group">
									<label>Nama</label>
									<input name="nama" id="nF" type="text" class="form-control" placeholder="Nama Barang" pattern="[A-Za-z0-9\s]+" title="Symbol characters are not allowed" required>
								</div>
								<div class="form-group">
									<label>Jenis Barang</label>
									<input name="jenis" id="jF" type="text" class="form-control" placeholder="Jenis / Kategori Barang" required>
								</div>
								<div class="form-group">
									<label>Merk</label>
									<input name="merk" id="mF" type="text" class="form-control" placeholder="Merk Barang" required>
								</div>
								<div class="form-group">
									<!-- <label>Ukuran</label>
									<input name="ukuran" id="uF" type="text" class="form-control" placeholder="Ukuran" required> -->
								</div>
								<div class="form-group">
									<label>Jumlah</label>
									<input name="stock" id="sF" type="number" min="0" class="form-control" placeholder="Qty" required>
								</div>
								<div class="form-group">
                                    <label>Satuan</label>
                                    <input name="satuan" id="saF" type="text" class="form-control" placeholder="Satuan" required>
									<!-- <select name="satuan" id="saF" class="custom-select form-control">
								...
								<div class="form-group">
									<label>Lokasi</label>
									<input name="lokasi" id="lF" type="text" class="form-control" placeholder="Lokasi barang" required>
								</div>
	...
	<script type='text/javascript'>
        ...
        var regex = /^[A-Za-z\s]+$/;
        if (!regex.test(input)) {
            alert("Input hanya boleh mengandung huruf dan spasi!");
            return false;
        } else {
            return true;
        }
