...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if($jumlah >= $qtyskrg){
            ...
            $updatedata1 = mysqli_query($conn,"update sbrg_keluar set tgl='$tanggal',jumlah='$jumlah',penerima='$penerima',keterangan='$keterangan',Harga Beli='$Harga Beli' where id='$id'");
            ...
            $updatedata = mysqli_query($conn,"update sbrg_keluar set tgl='$tanggal', jumlah='$jumlah', penerima='$penerima', keterangan='$keterangan',Harga Beli='$Harga Beli' where id='$id'");
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a style="color: black;" href="index.php">Toko Kirana</a>
            </div>
            <div class="main-menu">
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="active">
                                    ...
                                    <li class="active"><a href="keluar.php"><i class="ti-minus"></i><span>Barang Keluar</span></a></li>
                                </ul>
                            </li>
                            <li>
											...
											while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <input type="number" id="Harga Beli" name="Harga Beli" class="form-control" value="<?php echo $b['Harga Beli'] ?>">
						...
						<div class="modal-body">
							<form action="barang_keluar_act.php" method="post">
								...
								<div class="form-group">
									...
									<input name="Harga Beli" type="text" class="form-control" placeholder="Harga Beli" required>
								</div>
