    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php" style="text-decoration: none; color:black;">TOKO SURYA MAS 2</a>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li class="active"><a href="index.php"><span>Notes Barang</span></a></li>
                            <li>
            ...
            <div class="header-area">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <center>
                            <div>
                                <h2><span class='badge badge-secondary'><?= $_SESSION['level'];?> <?= $_SESSION['role'];?></span></h2>
                            </div>
                        </center>
                    </div>
                                    ...
                                    <div class="table-responsive">
										...
										<tr>
										 ...
										 <tr class="table-active">
											<td><center><input type = 'hidden' value="<?php echo $_SESSION['text']; ?>"/></center> </td>
											<td><center><input type = 'text' class='form-control' name = 'konten' required /></center> </td>
											<td>
                                                <center>
                                                    <input type = 'date' name='tgl' id="dateInput" class="form-control" value="<?php echo date('Y-m-d'); ?>" disabled/>
                                                </center>
                                            </td>
                                            <td>
                                                <input type="text" class='form-control' value="<?php echo $_SESSION['user'], ' ', $_SESSION['role'];?>" disabled>
                                            </td>
											<!-- <td>
                                                <center>
                                                 Saya, 
										...
										$id = $data['id'];
										 echo "  <form method ='POST' action = 'done.php'>
										  ...
										  <td><strong><center>".$data['tgl']."</center></strong></td>
										  <td><strong><center>".$data['admin']."</strong><span class='badge badge-secondary'>".$_SESSION['role']."</span></center></td>
