                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li class="active"><a href="index.php"><i class="ti-pencil"></i><span>Notes Barang</span></a></li>
							<li><a href="addkaryawan.php"><i class="ti-user"></i><span>Add Employe</span></a></li>
                            <li>
